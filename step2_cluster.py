...
def plot(data, density_threshold, distance_threshold, auto_select_dc = False):
	...
	rho, delta, nneigh, cluster, ccenter = dpcluster.cluster(distances_matrix, max_dis, min_dis, max_id, density_threshold, distance_threshold, auto_select_dc = auto_select_dc)

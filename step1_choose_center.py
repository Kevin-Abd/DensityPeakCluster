...
if __name__ == '__main__':
    ...
    # plot('./data/data_others/spiral_distance.dat', 25, 4, False)
    # plot('./data/data_others/aggregation_distance.dat', 25, 4, False)
    # plot('./data/data_others/flame_distance.dat', 15, 7, False)
    # plot('./data/data_others/jain_distance.dat', 20, 5, False)
